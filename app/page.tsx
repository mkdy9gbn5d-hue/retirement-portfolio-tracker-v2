      ...
      >
        <div className="flex justify-between items-start">
          ...
          <div className="text-right">
            ...
            <div className="text-3xl font-semibold text-emerald-400 mt-2">+1.26%</div>
          </div>
        </div>
      </motion.div>
      ...
      <div className="bg-[#111] border border-[#333] rounded-3xl p-6 mb-6">
        <div className="flex justify-between items-end mb-6">
          ...
          <div className="text-right">
            ...
            <div className="text-4xl font-semibold text-[#e31937] mt-1">9.3%</div>
          </div>
        </div>
        ...
        <div className="mb-5">
          <div className="flex justify-between text-sm mb-2">
            <div>Eric</div>
            <div className="font-medium tabular-nums">$302,085</div>
          </div>
          <div className="h-1.5 bg-[#222] rounded-full overflow-hidden">
            <div className="h-1.5 bg-[#e31937] rounded-full" style={{ width: '6.0%' }}></div>
          </div>
          <div className="text-xs text-gray-400 mt-1 text-right">6.0% of goal</div>
        </div>
        ...
        <div>
          <div className="flex justify-between text-sm mb-2">
            <div>Bridget</div>
            <div className="font-medium tabular-nums">$164,423</div>
          </div>
          <div className="h-1.5 bg-[#222] rounded-full overflow-hidden">
            <div className="h-1.5 bg-[#e31937] rounded-full" style={{ width: '3.3%' }}></div>
          </div>
          <div className="text-xs text-gray-400 mt-1 text-right">3.3% of goal</div>
        </div>
      </div>
